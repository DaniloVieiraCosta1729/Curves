...
var ASM_CONSTS = {
  92796: () => { if (document.fullscreenElement) return 1; },  
 92842: () => { return Module.canvas.width; },  
 92874: () => { return parseInt(Module.canvas.style.width); },  
 92922: () => { document.exitFullscreen(); },  
 92949: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 93022: () => { if (document.fullscreenElement) return 1; },  
 93068: () => { return Module.canvas.width; },  
 93100: () => { return screen.width; },  
 93125: () => { document.exitFullscreen(); },  
 93152: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 93285: () => { return window.innerWidth; },  
 93311: () => { return window.innerHeight; },  
 93338: () => { if (document.fullscreenElement) return 1; },  
 93384: () => { return Module.canvas.width; },  
 93416: () => { return parseInt(Module.canvas.style.width); },  
 93464: () => { if (document.fullscreenElement) return 1; },  
 93510: () => { return Module.canvas.width; },  
 93542: () => { return screen.width; },  
 93567: () => { return window.innerWidth; },  
 93593: () => { return window.innerHeight; },  
 93620: () => { if (document.fullscreenElement) return 1; },  
 93666: () => { return Module.canvas.width; },  
 93698: () => { return screen.width; },  
 93723: () => { document.exitFullscreen(); },  
 93750: () => { if (document.fullscreenElement) return 1; },  
 93796: () => { return Module.canvas.width; },  
 93828: () => { return parseInt(Module.canvas.style.width); },  
 93876: () => { document.exitFullscreen(); },  
 93903: ($0) => { Module.canvas.style.opacity = $0; },  
 93941: () => { return screen.width; },  
 93966: () => { return screen.height; },  
 93992: () => { return window.screenX; },  
 94019: () => { return window.screenY; },  
 94046: () => { return window.devicePixelRatio; },  
 94082: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 94135: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94186: () => { Module.canvas.style.cursor = 'none'; },  
 94223: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 94479: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 94530: () => { if (document.pointerLockElement) return 1; },  
 94577: () => { if (document.fullscreenElement) return 1; },  
 94623: () => { return window.innerWidth; },  
 94649: () => { return window.innerHeight; }
};
